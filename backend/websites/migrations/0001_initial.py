    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('secondary_color_scheme', models.CharField(blank=True, max_length=50, null=True)),
                ('deployment_status', models.CharField(choices=[('pending', 'Pending'), ('in_progress', 'In Progress'), ('completed', 'Completed'), ('failed', 'Failed')], default='pending', max_length=20)),
                ...
                ('cookie_accept_button_text', models.CharField(default='Accept All', max_length=50)),
                ('cookie_decline_button_text', models.CharField(default='Decline All', max_length=50)),
                ...
                ('template', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='websites.template')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tenant', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='websites', to='tenants.tenant')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('preview_email', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='trackers', to='websites.previewemail')),
            ],
            options={
                'ordering': ['-opened_at'],
            },
        ...
        migrations.AddField(
            ...
            name='website',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='preview_emails', to='websites.website'),
        ),
        migrations.CreateModel(
            name='Page',
            fields=[
